...
import (
	...
	"micah.wiki/demo/readgorm/dal/model"
)
...
func newSysMenu(db *gorm.DB, opts ...gen.DOOption) sysMenu {
	...
	_sysMenu.IsCache = field.NewInt64(tableName, "is_cache")
...
type sysMenu struct {
	...
	OrderNum   field.Int64  // 显示顺序
	Path       field.String // 路由地址
	Component  field.String // 组件路径
	Query      field.String // 路由参数
	IsFrame    field.Int64  // 是否为外链（0是 1否）
	IsCache    field.Int64  // 是否缓存（0缓存 1不缓存）
